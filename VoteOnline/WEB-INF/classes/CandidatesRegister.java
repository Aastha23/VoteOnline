...
public class CandidatesRegister extends HttpServlet
{
	...
	{	int i=0,j=0;
		...
		String s5=req.getParameter("radio");
		String s6=req.getParameter("DOB");    
		String s7=req.getParameter("Email");
		String s8=req.getParameter("Motto");  
		String s9=req.getParameter("Comment");
		String s10=req.getParameter("Pass");
		PrintWriter pw=res.getWriter();
		
		
			pw.println(" <!DOCTYPE html><html lang='zxx'><head><title>Registration for candidates</title>");
		...
		{    
			pw.println("<h1 class='clr'>Registration Failed</h1><br></div><div class='clearfix'></div><div style='text-align:center' class='sim-button button12'><a href='../candidatesregister.html'>Retry</a></div>");
		}
